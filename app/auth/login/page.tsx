      ...
      >
        <div className="glass rounded-2xl p-8 border border-white/10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Built for Hustlers. Powered by Nutrition.</p>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-white/10 rounded-lg hover:bg-white/5 transition disabled:opacity-50"
          >
          ...
          <p className="text-center mt-6 text-gray-400">
            ...
            <Link href="/auth/register" className="text-green-400 font-semibold hover:text-green-300">
              Sign up
            </Link>
          </p>
        </div>
