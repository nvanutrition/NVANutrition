...
export default function PoliciesPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-dark text-white flex flex-col">
      <Navbar />
      ...
      <div className="flex-grow pt-32 pb-24 max-w-5xl mx-auto px-4 w-full">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400">Read our shipping, return terms, and store usage policies.</p>
        </div>
            ...
            <div className="md:col-span-3">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="glass p-8 md:p-10 rounded-3xl border border-white/10 shadow-2xl bg-neutral-900/60 backdrop-blur-md"
                >
                  <h2 className="text-2xl font-extrabold text-white mb-6 flex items-center gap-3 pb-4 border-b border-white/10">
                    {activeContent && <activeContent.icon className="text-green-500" />}
                    {activeContent?.label}
                  </h2>
                  <div className="text-gray-300 leading-relaxed whitespace-pre-wrap text-sm md:text-base font-medium space-y-4">
                    {activeContent?.text}
                  </div>
                </motion.div>
              </AnimatePresence>
