...
export default function AdminSetupPage() {
 ...
 <p className="text-muted-foreground mb-6">Your admin account has been created successfully.</p>
 ...
 <p className="text-foreground font-mono text-lg">{adminData?.email}</p>
 </div>
 ...
 <p className="text-foreground font-semibold mb-2">Final Step: Set Admin Role</p>
 <p className="text-muted-foreground text-sm mb-3">
 Your user document has been created automatically. Now set the role to "admin" in Firebase Console:
 </p>
 <ol className="text-muted-foreground text-sm list-decimal list-inside space-y-1 mb-3">
 ...
 <li>Open the document with ID: <span className="text-foreground font-mono">{adminData?.uid?.slice(0, 8)}...</span></li>
 <li>Edit or add a field: <span className="text-foreground font-mono">role: "admin"</span> (string type)</li>
 <li>Click Save</li>
 </ol>
 <a
 ...
 <p className="text-muted-foreground mb-6">Fill in the details below to create your admin account.</p>
 ...
 className="w-full px-4 py-2 bg-muted border border-border text-foreground placeholder:text-foreground/30 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"
 required
 />
 </div>
 ...
 className="flex-1 border-2 border-border hover:bg-muted text-foreground py-2 rounded-lg font-bold transition"
 >
 Back
 </button>
 <button
 ...
 <span className="text-foreground font-bold text-3xl">NV</span>
 </div>
 <h1 className="text-3xl font-bold text-foreground mb-2">Admin Setup</h1>
 <p className="text-muted-foreground">Create your first admin account to access the admin panel</p>
 </div>
 ...
 <div>
 <h3 className="text-foreground font-semibold mb-1">Create Admin Account</h3>
 <p className="text-muted-foreground text-sm">Fill in your details to create an admin account</p>
 </div>
 </div>
 ...
 <div>
 <h3 className="text-foreground font-semibold mb-1">Access Admin Panel</h3>
 <p className="text-muted-foreground text-sm">Log in and navigate to /admin to manage your store</p>
 </div>
 </div>
 ...
 <div>
 <h3 className="text-foreground font-semibold mb-1">Manage Everything</h3>
 <p className="text-muted-foreground text-sm">Products, orders, customers, and more</p>
 </div>
 </div>
 </div>
