...
export default function AdminStock() {
 ...
 <p className="text-muted-foreground mt-2">Monitor and update inventory levels in real time</p>
 </div>
 ...
 className="w-full pl-10 pr-4 py-2.5 bg-muted border border-border rounded-xl text-foreground placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 transition"
 />
 </div>
 <button
 onClick={fetchProducts}
 disabled={loading}
 className="flex items-center gap-2 bg-muted hover:bg-muted border border-border text-foreground px-4 py-2.5 rounded-xl font-semibold transition cursor-pointer disabled:opacity-50"
 >
 ...
 <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Total Products</p>
 <h3 className="text-3xl font-black text-foreground mt-2">{totalProducts}</h3>
 </div>
 <div className="glass rounded-xl p-5 border-l-4 border-green-500">
 <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Healthy Stock</p>
 ...
 <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Low Stock (&le;10)</p>
 ...
 <div className="glass text-center py-16 border border-border rounded-xl">
 ...
 initial={{ opacity: 0, y: 20 }}
 animate={{ opacity: 1, y: 0 }}
 className="glass rounded-xl shadow-lg overflow-hidden border border-border"
 >
 <div className="overflow-x-auto">
 <table className="w-full text-left">
 <thead className="bg-muted border-b border-border">
 <tr>
 <th className="px-6 py-4 text-sm font-bold text-foreground uppercase tracking-wider">Product</th>
 <th className="px-6 py-4 text-sm font-bold text-foreground uppercase tracking-wider">Category</th>
 <th className="px-6 py-4 text-sm font-bold text-foreground uppercase tracking-wider">Price</th>
 <th className="px-6 py-4 text-sm font-bold text-foreground uppercase tracking-wider">Status</th>
 <th className="px-6 py-4 text-sm font-bold text-foreground uppercase tracking-wider w-52">Update Stock</th>
 </tr>
 </thead>
 ...
 return (
 <tr key={product.id} className="hover:bg-muted transition duration-150">
 {/* Product */}
 <td className="px-6 py-4">
 <div className="flex items-center gap-4">
 <div className="w-12 h-12 bg-muted rounded-lg overflow-hidden flex-shrink-0 flex items-center justify-center border border-border">
 {product.images?.[0] ? (
 <img
 ...
 <div>
 <p className="text-foreground font-bold text-sm line-clamp-1">{product.name}</p>
 ...
 {/* Category */}
 <td className="px-6 py-4">
 <span className="text-muted-foreground text-sm font-semibold bg-muted px-3 py-1 rounded-lg">
 {product.category}
 </span>
 </td>
 ...
 Current: <span className="text-foreground font-bold">{product.stock}</span> units
 </p>
 </div>
 </td>
 ...
 className="w-24 px-3 py-2 bg-muted border border-border hover:border-border focus:border-green-500 focus:ring-2 focus:ring-green-500/20 rounded-lg text-foreground text-sm font-mono font-bold focus:outline-none transition"
 />
 <button
