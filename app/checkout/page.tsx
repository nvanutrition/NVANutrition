...
export default function CheckoutPage() {
 ...
 <div>
 <h3 className="font-black text-foreground text-base">NVA Nutrition Payments</h3>
 ...
 className="text-gray-500 hover:text-foreground font-bold p-1 bg-gray-200 rounded-full hover:bg-gray-300 transition"
 >
 &times;
 </button>
 </div>
 ...
 <h4 className="text-xl font-bold text-foreground mb-2">Payment Authorized!</h4>
 ...
 <h4 className="text-lg font-bold text-foreground mb-2">Processing Transaction...</h4>
 <p className="text-gray-500 text-sm font-semibold">Contacting secure sandbox server...</p>
 </div>
 ) : (
 ...
 <div>
 <label className="block text-[11px] font-bold text-gray-500 mb-1.5 uppercase tracking-wider">Card Number</label>
 <input
 type="text"
 value={sandboxCardNumber}
 onChange={(e) => handleSimulatedCardNumberChange(e.target.value)}
 placeholder="4111 2222 3333 4444"
 className="w-full bg-white border border-gray-200 hover:border-gray-300 focus:border-green-500 rounded-xl px-4 py-3 text-foreground font-mono placeholder-gray-400 focus:outline-none transition"
 />
 </div>
 <div className="grid grid-cols-2 gap-4">
 <div>
 <label className="block text-[11px] font-bold text-gray-500 mb-1.5 uppercase tracking-wider">Expiry Date</label>
 <input
 type="text"
 value={sandboxExpiry}
 ...
 <div>
 <label className="block text-[11px] font-bold text-gray-500 mb-1.5 uppercase tracking-wider">CVV</label>
 <input
 type="password"
 value={sandboxCvv}
 ...
 <div className="space-y-4">
 <div>
 <label className="block text-[11px] font-bold text-gray-500 mb-1.5 uppercase tracking-wider">Virtual Payment Address (VPA)</label>
 <input
 type="text"
 value={sandboxUpiId}
 ...
 className="w-full bg-green-500 hover:bg-green-600 text-white font-extrabold py-4 rounded-xl transition text-base shadow-[0_8px_20px_rgba(0,200,83,0.25)] hover:shadow-[0_12px_24px_rgba(0,200,83,0.35)] flex items-center justify-center gap-2 cursor-pointer"
 >
 <Lock size={16} />
 ...
 <p className="text-sm text-gray-500 mt-1 font-medium">Pay securely via Credit Cards, Debit Cards, Net Banking, or instant mobile UPI wallet.</p>
 </div>
 </div>
 === END RAZORPAY HIDDEN === */}
 </div>
