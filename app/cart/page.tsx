            ...
            >
              ...
              <Link href="/products">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white px-10 py-4 rounded-xl font-bold text-lg transition shadow-lg cursor-pointer"
                >
                  Explore Products
                </motion.button>
              </Link>
                    ...
                    <div className="flex-1">
                      ...
                      {(item.flavor || item.unit) && (
                        <p className="text-sm text-gray-600 mb-3 flex flex-wrap gap-x-2 gap-y-1 items-center">
                          ...
                          {item.flavor && item.unit && <span className="text-gray-300">|</span>}
                          {item.unit && (
                            <>
                    ...
                    {freeGifts.map((gift, idx) => (
                      ...
                      >
                        ...
                        <div className="flex-1 flex flex-col justify-between py-1">
                          <div>
                            <span className="inline-block text-[10px] font-black tracking-widest uppercase bg-green-500 text-white px-2 py-0.5 rounded mb-2">
                              Free Gift
                            </span>
                ...
                <div className="space-y-3">
                  <Link href="/checkout" className="block">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white py-4 rounded-xl font-bold text-lg transition shadow-lg cursor-pointer"
                    >
                      Proceed to Checkout
                    </motion.button>
                  </Link>
