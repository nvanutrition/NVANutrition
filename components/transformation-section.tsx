...
export function TransformationSection() {
  ...
  return (
    <section className="relative py-28 overflow-hidden bg-gray-50 border-t border-gray-150">
      {/* Background elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center">
            ...
            {/* Instruction Badge */}
            <span className="mb-4 text-xs font-semibold text-gray-400 tracking-wider uppercase flex items-center gap-1.5 bg-gray-200/50 px-3 py-1 rounded-full">
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full">
                <Image
                  ...
                  priority
                />
                <div className="absolute bottom-6 left-6 bg-black/70 backdrop-blur-md text-white font-bold text-sm tracking-wider uppercase px-4 py-2 rounded-xl">
                  Before
                </div>
              </div>
