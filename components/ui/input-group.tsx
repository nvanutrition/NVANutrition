...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
 ...
 // Error state.
 'has-[[data-slot][aria-invalid=true]]:ring-destructive/20 has-[[data-slot][aria-invalid=true]]:border-destructive [[data-slot][aria-invalid=true]]:ring-destructive/40',
