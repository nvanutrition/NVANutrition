...
export function MotivationSection() {
  ...
  return (
    <section className="relative py-28 overflow-hidden bg-nv-dark text-white border-t border-b border-white/5">
        ...
        <div className="relative min-h-[220px] flex flex-col items-center justify-center text-center px-4 md:px-12">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="max-w-4xl"
            >
              <h2 className="text-3xl md:text-5xl font-black tracking-tight leading-tight mb-8 uppercase italic font-sans text-white/90">
              ...
              {/* Tag Stat */}
              <div className="mt-4">
                <span className="inline-block text-[10px] tracking-widest font-mono text-gray-500 uppercase px-3 py-1 border border-white/5 rounded-full bg-white/5">
        ...
        <div className="mt-16 flex flex-col items-center gap-6">
          ...
          <div className="flex gap-4">
            <motion.button
              ...
              className="p-3 border border-white/10 rounded-full transition-all duration-300 flex items-center justify-center text-white/70 hover:text-green-400 bg-white/5 backdrop-blur-md"
            ...
            {motivationalQuotes.map((_, index) => (
              <button
                ...
                className={`h-1 rounded-full transition-all duration-300 ${
                  index === currentQuote ? 'bg-green-500 w-6' : 'bg-white/20 w-1.5'
                }`}
